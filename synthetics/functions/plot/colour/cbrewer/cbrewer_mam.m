function [colormap]=cbrewer_mam(ctype, cname, ncol, interp_method)

warning('off','MATLAB:griddedInterpolant:CubicUniformOnlyWarnId') %mam
...
%     disp(' ')
    ...
    % Some corrections, MAM 2022/03/12
