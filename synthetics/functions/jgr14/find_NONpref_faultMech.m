function [strike,dip,rake]=find_NONpref_faultMech(strike1,dip1,rake1, str_master,dip_master,rak_master)
% Find the one fault mechanism (= uniquely defined slip and normal vectors) 
% of a FM which is FURTHER from a "master" fault mechanism
%
...
% If FM2 is closer to the regional master FM, use it instead of the
% catalog FM
