function [Slat,Slon,Sz] = srcPlot(lat,lon,depth,strike,dip,src_length,i)
...
view(az, el);
    ...
    plot3([Slon(1,i) Slon(2,i)],[Slat(1,i) Slat(2,i)],[Sz(1,i) Sz(1,i)],'r')
    plot3([Slon(3,i) Slon(4,i)],[Slat(3,i) Slat(4,i)],[Sz(2,i) Sz(2,i)],'r')
    plot3([Slon(1,i) Slon(3,i)],[Slat(1,i) Slat(3,i)],[Sz(1,i) Sz(2,i)],'r')
    plot3([Slon(2,i) Slon(4,i)],[Slat(2,i) Slat(4,i)],[Sz(1,i) Sz(2,i)],'r')
    
    plot3([Slon(1,i) Slon(4,i)],[Slat(1,i) Slat(4,i)],[Sz(1,i) Sz(2,i)],'r','linewidth',18)
    plot3([Slon(2,i) Slon(3,i)],[Slat(2,i) Slat(3,i)],[Sz(1,i) Sz(2,i)],'r')
