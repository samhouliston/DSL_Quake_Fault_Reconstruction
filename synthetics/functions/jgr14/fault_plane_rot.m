function phi = fault_plane_rot(str1,dip1,rak1,str2,dip2,rak2)
...
% Men-Andrin Meier, 110418, menandrin@gmail.com
...
% FM1 --------------------------------------------------
str1 = str1*deg2rad; dip1 = dip1*deg2rad; rak1 = rak1*deg2rad;

t1_1 = (-sin(str1)*sin(dip1) + cos(str1)*cos(rak1) + sin(str1)*cos(dip1)*sin(rak1))/sqrt(2);
t1_2 = (cos(str1)*sin(dip1) + sin(str1)*cos(rak1) - cos(str1)*cos(dip1)*sin(rak1))/sqrt(2);
t1_3 = (-cos(dip1) - sin(dip1)*sin(rak1))/sqrt(2);
t1   = [t1_1; t1_2; t1_3];

p1_1 = (-sin(str1)*sin(dip1) - cos(str1)*cos(rak1) - sin(str1)*cos(dip1)*sin(rak1))/sqrt(2);
p1_2 = (cos(str1)*sin(dip1) - sin(str1)*cos(rak1) + cos(str1)*cos(dip1)*sin(rak1))/sqrt(2);
p1_3 = (-cos(dip1) + sin(dip1)*sin(rak1))/sqrt(2);
p1   = [p1_1; p1_2; p1_3];

b1_1 = cos(str1)*sin(rak1) - sin(str1)*cos(dip1)*cos(rak1); 
b1_2 = sin(str1)*sin(rak1) + cos(str1)*cos(dip1)*cos(rak1); 
...
% FM2  --------------------------------------------------
str2 = str2*deg2rad; dip2 = dip2*deg2rad; rak2 = rak2*deg2rad;

t2_1 = (-sin(str2)*sin(dip2) + cos(str2)*cos(rak2) + sin(str2)*cos(dip2)*sin(rak2))/sqrt(2);
t2_2 = (cos(str2)*sin(dip2) + sin(str2)*cos(rak2) - cos(str2)*cos(dip2)*sin(rak2))/sqrt(2);
t2_3 = (-cos(dip2) - sin(dip2)*sin(rak2))/sqrt(2);
t2   = [t2_1; t2_2; t2_3];

p2_1 = (-sin(str2)*sin(dip2) - cos(str2)*cos(rak2) - sin(str2)*cos(dip2)*sin(rak2))/sqrt(2);
p2_2 = (cos(str2)*sin(dip2) - sin(str2)*cos(rak2) + cos(str2)*cos(dip2)*sin(rak2))/sqrt(2);
p2_3 = (-cos(dip2) + sin(dip2)*sin(rak2))/sqrt(2);
p2   = [p2_1; p2_2; p2_3];

b2_1 = cos(str2)*sin(rak2) - sin(str2)*cos(dip2)*cos(rak2); 
b2_2 = sin(str2)*sin(rak2) + cos(str2)*cos(dip2)*cos(rak2); 
