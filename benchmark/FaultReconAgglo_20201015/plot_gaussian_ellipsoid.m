...
NOISE_LIM = inf; %Maximum thickness of an ellipsoid to be plotted
...
switch numel(m)
   ...
   case 3, h=show3d(m(:),C,sdwidth,npts,axh,NOISE_LIM);
   otherwise
...
%-----------------------------
function h = show3d(means, C, sdwidth, npts, axh,NOISE_LIM)
