function [verts] = DrawCuboidYK(meanVec,covMat,colr,alph)
% Draw Cuboid
...
verts = zeros(3,8);
for i = 1:8
    verts(1:3,i) = R*[x(i);y(i);z(i)]+eye(3,3)*CV;
end

%% Draw Patch Object
if(nargout~=1)
    patch('Faces',facs,'Vertices',verts','FaceColor',colr,'FaceAlpha',alph);%colr
end
end